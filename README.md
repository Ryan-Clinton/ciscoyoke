...
**Pre-alpha.** The P0 read-only core is implemented and tested:
...
Nothing yet writes to a device. Commands that mutate hardware land with the
recovery journal and the transport lease, not before — see
